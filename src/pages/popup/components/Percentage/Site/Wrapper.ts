...
import { generateSiteSeriesOption, generateTextOption, handleClick, type PieSeriesItemOption, tooltipFormatter } from "../chart"
        ...
        const options: EcOption = {
            ...
            toolbox: {
                ...
                feature: {
                    saveAsImage: {
                        show: true,
                        title: t(msg => msg.percentage.saveAsImageTitle),
                        // file name
